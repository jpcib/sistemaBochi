...
data_infra <- read_csv("../data/infra_gop_18-10.csv") %>% 
...
data_mtom <- read_csv("../data/mtom_2021_2023_13-11_framed.csv") %>% 
...
data_mobi <- read_csv("../data/base_mobiliario_itemizada_13-11.csv") %>% 
...
data_seguridad <- read_csv("../data/tabla_seguridad_12-10-2023.csv") %>% 
