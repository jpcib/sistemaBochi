...
data_infra <- read_csv("../data/infra_gop_14-08.csv") %>% 
...
data_mtom <- read_csv("../data/mtom_2021_2023_11-08_framed.csv") %>% 
...
data_mobi <- read_csv("../data/base_mobiliario_itemizada_14-08.csv") %>% 
