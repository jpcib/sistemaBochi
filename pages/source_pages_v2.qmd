...
data_infra <- read_csv("../data/infra_gop_06-07.csv") %>% 
...
#                                 "    + ", "Inicio de obra: ", id_data$inicio_obra, " - ", "Avance: ", id_data$avance_de_obra, " - ", "Plazo: ", id_data$plazo_obra, " días", " \n\n")  
#       } else if (any(id_data$estado == "Finalizado")) {
#         projects_list <- paste0("* ", id_data$intervenciones, " \n", 
#                                 "    + ", id_data$eje, " - ", id_data$estado, " \n",
#                                 "    + ", "Finalizada el ", id_data$fin_obra, " \n\n") 
#       # } else if (any(id_data$estado == "Planificado")) {
#       #   projects_list <- paste0("* ", id_data$intervenciones, " \n", 
#       #                           "    + ", id_data$eje, " - ", id_data$estado, " \n",
#       #                           "    + ", id_data$fin_obra, " \n\n") 
#       } else {
...
data_mtom <- read_csv("../data/mtom_2021_2023_06-07_framed.csv") %>% 
...
data_mobi <- read_csv("../data/base_mobiliario_itemizada_06-07.csv") %>% 
