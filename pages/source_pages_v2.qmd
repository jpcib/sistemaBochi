...
data <- read_csv("../data/base_completa_link_v4.csv") %>%
  # slice_head(n = 3)
  glimpse()
```
...
data_infra <- read_csv("../data/infra_gop_12-04.csv") %>% 
    ...
    if (file.exists(file_path)) {
      ...
      if (any(id_data$estado == "En Obra")) {
        projects_list <- paste0("* ", id_data$intervenciones, " \n", 
                                "    + ", id_data$eje, " - ", id_data$estado, " \n",
                                "    + ", "Inicio de obra: ", id_data$inicio_obra, " - ", "Avance: ", id_data$avance_de_obra, " - ", "Plazo: ", id_data$plazo_obra, " \n\n")  
      } else {
        projects_list <- paste0("* ", id_data$intervenciones, " \n", 
                                "    + ", id_data$eje, " - ", id_data$estado, " \n",
                                "    + ", "Inicio de obra:", id_data$inicio_obra, " \n\n") 
      }
...
data_mtom <- read_csv("../data/mtom_2019_2023_16-03_framed.csv") %>% 
...
data_mobi <- read_csv("../data/base_mobiliario_itemizada_v2.csv") %>% 
